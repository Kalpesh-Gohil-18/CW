...
(function () {
    ...
    class d3PieChart extends HTMLElement {
        ...
        async render(sel) {
            ...
            function DonutChart(data, {
                ...
                innerRadius = Math.min(width-50, height-50) / 3, // inner radius of pie, in pixels (non-zero for donut)
            ...
            console.log(chart);
            // const svg=d3.select(this._root).append("chart");

            // const svg = document.querySelector(this._root);
            // svg.append(chart);
    ...
    customElements.define("d3-pie-chart", d3PieChart);
